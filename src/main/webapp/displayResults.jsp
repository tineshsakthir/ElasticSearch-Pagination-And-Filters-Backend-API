...
<p><strong>Senders:</strong> <%= Arrays.toString(senders) %></p>
<p><strong>Recipients:</strong> <%= Arrays.toString(recipients) %></p>
<p><strong>Message Trace Id:</strong> <%= Arrays.toString(messageTraceIds) %></p>
<p><strong>Subjects:</strong> <%= Arrays.toString(subjects) %></p>
<p><strong>From IP:</strong> <%= Arrays.toString(fromIps) %></p>
<p><strong>To IP:</strong> <%= Arrays.toString(toIps) %></p>
<p><strong>Sizes:</strong> <%= Arrays.toString(sizes) %></p>
<p><strong>Sizes From:</strong> <%= Arrays.toString(sizes_from) %></p>
<p><strong>Sizes To:</strong> <%= Arrays.toString(sizes_to) %></p>
<p><strong>Received:</strong> <%= Arrays.toString(receiveds) %></p>
<p><strong>Received From:</strong> <%= Arrays.toString(receiveds_from) %></p>
<p><strong>Received To:</strong> <%= Arrays.toString(receiveds_to) %></p>
...
<%--    <button id="DateRange" type="button" class="btn btn-outline-secondary" onclick="addFilterField('DateRange')">Date Range</button>--%>
    ...
    <button type="button" class="btn btn-outline-secondary" onclick="addMessageTraceIdField()">Add Message Trace ID</button>
    ...
    <button type="button" class="btn btn-outline-secondary" onclick="addReceivedRangeField()">Add Received Date Range</button>
</div>
...
<form id="filter-container" class="filter-container" action="${pageContext.request.contextPath}/pagination" method="get">
    ...
    <div id="SENDERS">
        ...
        <div class="filter-field">
            ...
            <input type="email" name="SENDER[]" class="form-control" placeholder="Enter Sender Email" value="<%= sender %>" required>
    ...
    <div id="RECIPIENTS">
        ...
        <div class="filter-field">
            ...
            <input type="email" name="RECIPIENT[]" class="form-control" placeholder="Enter Recipient Email" value="<%= recipient %>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="MESSAGE_TRACE_IDS">
        ...
        <div class="filter-field">
            ...
            <input type="text" name="MESSAGE_TRACE_ID[]" class="form-control" placeholder="Enter Message Trace ID" value="<%= messageTraceId %>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="FROM_IPS">
        ...
        <div class="filter-field">
            <label>From IP</label>
            <input type="text" name="FROM_IP[]" class="form-control" placeholder="Enter From IP" value="<%= fromIp %>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="SIZES">
        ...
        <div class="filter-field">
            ...
            <input type="number" name="SIZE[]" class="form-control" placeholder="Enter Size" value="<%= size %>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="SIZE_RANGES">
        ...
        <div class="filter-field">
            ...
            <input type="number" name="SIZE_FROM[]" class="form-control" placeholder="Min Size" value="<%= sizes_from[i] %>" required>
            <input type="number" name="SIZE_TO[]" class="form-control" placeholder="Max Size" value="<%= sizes_to[i] %>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="RECEIVEDS">
        ...
        <div class="filter-field">
            ...
            <input type="datetime-local" name="RECEIVED[]" class="form-control" placeholder="Enter Date" value="<%=received%>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
    ...
    <div id="RECEIVED_RANGES">
        ...
        <div class="filter-field">
            ...
            <input type="datetime-local" name="RECEIVED_FROM[]" class="form-control" placeholder="From Date" value="<%=receiveds_from[i]%>" required>
            <input type="datetime-local" name="RECEIVED_TO[]" class="form-control" placeholder="To Date" value="<%=receiveds_to[i]%>" required>
            <button type="button" onclick="removeFilter(this)">Remove</button>
        </div>
        <%
                }
